...
def calculate_score(cards):
    "Take a list of the cards and return the calculated from the cards"
...
def play_game():
    ...
    while not is_game_over:
        ...
        print(f"Computer cards {computer_cards} and the score {computer_score}")
    ...
    print(f"Computer final cards {computer_cards} and the score {computer_score}")
